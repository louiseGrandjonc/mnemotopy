 ...
 * LICENSE: 71a514e1966385db30b85bf5ab4a0031
...
Galleria.addTheme({
    ...
    version: 1.50,
    author: 'Galleria',
    css: 'galleria.folio.min.css?v=1.5.0',
    defaults: {
        transition: 'pulse',
        thumbCrop: 'width',
        imageCrop: false,
    ...
    init: function(options) {
        ...
        Galleria.requires( 1.5, 'This version of Folio theme requires Galleria version 1.5 or later');
